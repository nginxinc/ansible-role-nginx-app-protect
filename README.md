...
**Warning:** As of the latest NGINX Plus release, R25, NGINX App Protect will no longer. The only workaround at this time is to install NGINX Plus R24 before attempting to install NGINX App Protect WAF/DoS. A fix is planned in NGINX App Protect 3.6, planned for release mid-October.
